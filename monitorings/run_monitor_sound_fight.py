...
log = logging.getLogger("run_monitor_sound_fight")
...
def get_list_wires():
    try:
        ...
        cursor = conn.cursor()
        postgreSQL_select_Query = "select wire_id, wire_type_code, name, data, status from sound_fight where is_active='1'"
