...
log = logging.getLogger("run_monitor_single_path_movement")
...
def get_list_wires():
    try:
        ...
        cursor = conn.cursor()
        postgreSQL_select_Query = "select wire_id, wire_type_code, name, data, status from single_path_movement where is_active='1'"
