...
log = logging.getLogger("run_monitor_worker_started_shift")
...
def get_list_wires():
    try:
        ...
        cursor = conn.cursor()
        postgreSQL_select_Query = "select wire_id, wire_type_code, name, data, status from worker_started_shift where is_active='1'"
