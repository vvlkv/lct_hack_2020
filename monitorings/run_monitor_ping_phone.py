...
log = logging.getLogger("run_monitor_ping_phone")
...
def get_list_wires():
    try:
        ...
        cursor = conn.cursor()
        postgreSQL_select_Query = "select wire_id, wire_type_code, name, data, status from status_phone where is_active='1'"
