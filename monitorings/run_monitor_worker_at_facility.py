...
log = logging.getLogger("run_monitor_worker_at_facility")
...
def get_list_wires():
    try:
        ...
        cursor = conn.cursor()
        postgreSQL_select_Query = "select wire_id, wire_type_code, name, data, status from worker_at_facility where is_active='1'"
