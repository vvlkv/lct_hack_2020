...
log = logging.getLogger("run_monitor_fitness_bracelets")
...
def get_list_wires():
    try:
        ...
        cursor = conn.cursor()
        postgreSQL_select_Query = "select wire_id, wire_type_code, name, data, status from fitness_bracelets where is_active='1'"
