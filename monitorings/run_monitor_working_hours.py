...
log = logging.getLogger("run_monitor_working_hours")
...
def get_list_wires():
    try:
        ...
        cursor = conn.cursor()
        postgreSQL_select_Query = "select wire_id, wire_type_code, name, data, status from working_hours where is_active='1'"
